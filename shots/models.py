...
class Round (models.Model):
    ...
    payee = models.ForeignKey(Participant, on_delete=models.CASCADE, related_name="payees")
...
class RoundParticipant (models.Model):
    ...
    participant = models.ForeignKey(Participant, on_delete=models.CASCADE, related_name="roundParticipant")
